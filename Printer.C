...
void PrintAbsyn::visitCompundInstr(CompundInstr* p) {
    int oldi = _i_;
...
void PrintAbsyn::visitReturnExpr(ReturnExpr* p) {
    int oldi = _i_;
    if (oldi > 0) render(_L_PAREN);
...
void PrintAbsyn::visitExpresionInstr(ExpresionInstr* p) {
    int oldi = _i_;
    if (oldi > 0) render(_L_PAREN);
...
void ShowAbsyn::visitCompundInstr(CompundInstr* p) {
    bufAppend('(');
    bufAppend("CompundInstr");
    bufAppend(' ');
    bufAppend('[');
...
void ShowAbsyn::visitReturnExpr(ReturnExpr* p) {
    bufAppend("ReturnExpr");
}
...
void ShowAbsyn::visitExpresionInstr(ExpresionInstr* p) {
    bufAppend('(');
    bufAppend("ExpresionInstr");
    bufAppend(' ');
    bufAppend('[');
    if (p->expr_)  p->expr_->accept(this);
    bufAppend(']');
