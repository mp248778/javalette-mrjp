...
%token<string_> _IDENT_ "indetificator"
...
Instr : Instr1 {  $$ = $1;  } 
  ...
  | _SYMB_28 _SYMB_0 ListExpr _SYMB_4 ListExpr _SYMB_4 ListExpr _SYMB_1 Instr {  std::reverse($3->begin(),$3->end()) ; std::reverse($5->begin(),$5->end()) ; std::reverse($7->begin(),$7->end()) ;$$ = new ForLoop($3, $5, $7, $9); $$->line_number = yy_mylinenumber;  }
